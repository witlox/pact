...
| NodeDecommissioned | CLI (admin) | Journal, Loki, Raft revocation registry | Admin decommissioned node, cert revoked (ADR-008) | Node |
...
| CertRevoked | Journal (RevocationRegistry) | Journal, Raft revocation registry | Certificate revoked on decommission (ADR-008) | Node |
